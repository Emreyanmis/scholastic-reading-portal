...
import type { TeacherAssignment } from "./AssignmentsTable";
...
export function CreateAssignmentDialog({
  ...
  books: Book[];
  students: Student[];
  onCreated: (created: TeacherAssignment[]) => void;
}) {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      const body = (await res.json()) as { assignments: TeacherAssignment[] };
      onCreated(body.assignments);
    } finally {
      setBusy(false);
    }
  }
